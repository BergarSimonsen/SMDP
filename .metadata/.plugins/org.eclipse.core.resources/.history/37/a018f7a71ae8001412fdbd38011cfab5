 ...
 * <ul>
 *   <li>{@link Configurator.UnaryConstraint#getOperator <em>Operator</em>}</li>
 *   <li>{@link Configurator.UnaryConstraint#getOperand <em>Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @see Configurator.ConfiguratorPackage#getUnaryConstraint()
 * @model
 * @generated
 */
public interface UnaryConstraint extends Constraint {
	 ...
	 * The literals are from the enumeration {@link Configurator.UnaryOperator}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see Configurator.ConfiguratorPackage#getUnaryConstraint_Operator()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Configurator.UnaryConstraint#getOperator <em>Operator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
