		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getString0Access().getGroup_1(), "rule__String0__Group_1__0");
					...
					put(grammarAccess.getParameterAccess().getTypeAssignment_9(), "rule__Parameter__TypeAssignment_9");
					...
					put(grammarAccess.getString0Access().getValueAssignment_1_1(), "rule__String0__ValueAssignment_1_1");
