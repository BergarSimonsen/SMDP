 ...
 * <ul>
 *   <li>{@link Configurator.impl.UnaryConstraintImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link Configurator.impl.UnaryConstraintImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UnaryConstraintImpl extends ConstraintImpl implements UnaryConstraint {
	/**
	...
	protected EClass eStaticClass() {
		return ConfiguratorPackage.Literals.UNARY_CONSTRAINT;
	}
	...
	public void setOperator(UnaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfiguratorPackage.UNARY_CONSTRAINT__OPERATOR, oldOperator, operator));
	}
	...
	public void setOperand(BinaryConstraint newOperand) {
		if (newOperand != operand) {
			...
			if (operand != null)
				msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ConfiguratorPackage.UNARY_CONSTRAINT__OPERAND, null, msgs);
			if (newOperand != null)
				msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ConfiguratorPackage.UNARY_CONSTRAINT__OPERAND, null, msgs);
			msgs = basicSetOperand(newOperand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfiguratorPackage.UNARY_CONSTRAINT__OPERAND, newOperand, newOperand));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConfiguratorPackage.UNARY_CONSTRAINT__OPERATOR:
				return getOperator();
			case ConfiguratorPackage.UNARY_CONSTRAINT__OPERAND:
				return getOperand();
		}
