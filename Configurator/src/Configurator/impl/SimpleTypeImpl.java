 ...
 * <ul>
 *   <li>{@link Configurator.impl.SimpleTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleTypeImpl extends TypeImpl implements SimpleType {
	 ...
	 * @ordered
	 */
	protected static final TypeName NAME_EDEFAULT = TypeName.INT;
	 ...
	 * @ordered
	 */
	protected TypeName name = NAME_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return ConfiguratorPackage.Literals.SIMPLE_TYPE;
	}
	...
	public void setName(TypeName newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfiguratorPackage.SIMPLE_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConfiguratorPackage.SIMPLE_TYPE__NAME:
				return getName();
		}
